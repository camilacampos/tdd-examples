...
RSpec.describe RomanNumberConversion do
  ...
  it 'translates 3899 to MMMDCCCXCIX' do
    result = described_class.new.from_int(3899)

    expect(result).to eq 'MMMDCCCXCIX'
  end

  it 'return ERROR if number is greater than 3999' do
    result = described_class.new.from_int(4000)

    expect(result).to eq 'ERROR'
  end

  it 'return ERROR if number is less than 1' do
    result = described_class.new.from_int(0)
